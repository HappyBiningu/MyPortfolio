...
export default function ResourceLibrary() {
  ...
  return (
    <section id="resources" className="py-16 bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900 overflow-hidden relative">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl font-bold mb-4 text-white">Resource Library</h2>
          <p className="text-white/70 max-w-3xl mx-auto">
            Access curated datasets, starter code, and tutorials to accelerate your data science projects
          </p>
        </motion.div>
